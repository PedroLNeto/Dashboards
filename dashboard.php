...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link href="Template%20de%20dashboard,%20usando%20Bootstrap_arquivos/bootstrap.css" rel="stylesheet">

    <!-- Estilos customizados para esse template -->
    <link href="Template%20de%20dashboard,%20usando%20Bootstrap_arquivos/dashboard.css" rel="stylesheet">
...
@-webkit-keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}@keyframes chartjs-render-animation{from{opacity:0.99}to{opacity:1}}.chartjs-render-monitor{-webkit-animation:chartjs-render-animation 0.001s;animation:chartjs-render-animation 0.001s;}</style></head>
  ...
  <body>
    ...
    <script src="Template%20de%20dashboard,%20usando%20Bootstrap_arquivos/jquery-3.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
    <script>window.jQuery || document.write('<script src="../../assets/js/vendor/jquery-slim.min.js"><\/script>')</script>
    <script src="Template%20de%20dashboard,%20usando%20Bootstrap_arquivos/popper.js"></script>
    <script src="Template%20de%20dashboard,%20usando%20Bootstrap_arquivos/bootstrap.js"></script>

    <!-- Ícones -->
    <script src="Template%20de%20dashboard,%20usando%20Bootstrap_arquivos/feather.js"></script>
    <script>
      feather.replace()
    </script>

    <!-- Gráficos -->
    <script src="Template%20de%20dashboard,%20usando%20Bootstrap_arquivos/Chart.js"></script>
    <script>
